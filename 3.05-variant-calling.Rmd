...
```{r hc-time-test, out.width='100%', echo=FALSE}
knitr::include_graphics(path = "figs/haplotype-caller-run-times.svg")
```
...
In fact, this is one of the big selling points of the GenomicsDB approach, expecially
