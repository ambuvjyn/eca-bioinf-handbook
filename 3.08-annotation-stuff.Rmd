...
config file.
```sh
snpEff build -Xmx8g  -noCheckCds -noCheckProtein -gff3 -c resources/SnpEff/snpEff.config  -v Pearl_Millet_v1.1
```
...
```sh
mkdir results/vcf
bcftools concat results/vcf_parts/*.vcf > results/vcf/all.vcf
```
